...
from Loss.LimitBasedLoss import LimitBasedLoss
import torch.nn as nn


def getLoss(model, loss_str=None, gamma=0, gammap=0, gamman=0, reg_type='L2'):
    """
    ...
    if loss_str is 'margin':
        ...
        kwargs.pop('margin')
        kwargs.update({"margin_p": gammap, "margin_n": gamman})
        print ('Loss: Limit-based with positive margin:', gammap, ' and negative margin:', gamman)
        loss = LimitBasedLoss(**kwargs)
    else:
        pass
